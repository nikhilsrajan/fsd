    ...
    try:
        ...
        try:
            result = runners.run_local_inference(
                local_csv, cores=cores, bundle_path=local_bundle,
                cubes_per_task=cubes_per_task, predict_batch_size=predict_batch_size,
...
def _parse_args(argv=None) -> argparse.Namespace:
    ...
    p.add_argument("--cubes-per-task", type=int, default=1)
