---
status: current
summary: Companion walkthrough of the model bundle (`bundle.json` + adapter string) — how it saves, loads and infers; explains spec 18's design rather than adding to it.
---
